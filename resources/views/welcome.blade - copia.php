...
<html lang="zxx">
   <head>
      <title>Economy an Business Category Bootstrap Responsive web Template| Home :: w3layouts</title>
      <!--meta tags -->
      <meta charset="UTF-8">
      ...
      <div class="main-top" id="home">
         ...
         <div class="headder-top">
            <div class="container-fluid">
               ...
               <nav >
                  <div id="logo">
                     <h1><a class="" href="index.html"><span class="fa fa-ravelry mr-2" aria-hidden="true"></span>Economy</a></h1>
                  </div>
      ...
      <footer class="py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
            ...
            <div class="footer-main txt-center ">
               <p> 
                  © 2019 Economy
                  . All Rights Reserved | Design by <a href="http://www.W3Layouts.com" target="_blank">W3Layouts</a>
               </p>
            </div>
            <!-- move icon -->
