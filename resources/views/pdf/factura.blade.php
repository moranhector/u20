    ...
    <div>
        ...
        <table>
            ...
            <tr>
                ...
                <td width="50%" align="left" style="border:0;"  >
                <B>  Ingresos Brutos: </B> {{$ingresos_brutos}}
                </td>
            </tr>            
            ...
            <tr>
                ...
                <td width="50%" align="left"  style="border:0;"  >
                <B>     Fecha de Inicio de Actividades:  </B> {{$fecha_inicio}}
                </td>
            </tr>   
        ...
        <table  width="100%" class="tabla3" >
            <tr>
                ...
                <B>   CUIT:  </B>   {{$cuit_cliente}}
                </td>                            

                <td width="70%" align="left" style="border:0;" >
                <B>            Apellido y Nombre / Razón Social:   </B> {{$nombres}}
                </td>
        ...
        <table width="100%" class="tabla3">
            ...
            <tr>
                <td width="9%" align="center"><span class="text">{{ $detalle[$i]['id_articulo'] }}</span></td>            
                <td width="48%"><span class="text">{{ $detalle[$i]['descrip'] }}</span></td>                
                <td width="9%" align="center"><span class="text">{{ $detalle[$i]['cantidad'] }}</span></td>
                <td width="16%" align="right"><span class="text">{{ $detalle[$i]['precio'] }}</span></td>
                <td width="18%" align="right"><span class="text">{{ $detalle[$i]['importe'] }}</span></td>
            </tr>
            @else
            <tr>
                <td width="9%">&nbsp;</td>
